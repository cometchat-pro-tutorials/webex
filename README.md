# How to Build a Webex Clone Chat App

Read the full tutorial here: [**>> How to Build a Webex Clone Chat App**](https://www.cometchat.com/tutorials/#)
...
2. From the [dashboard](https://app.cometchat.com/apps), add a new app called **"webex"**
3. Select this newly added app from the list.
4. From the Quick Start copy the **APP_ID, APP_REGION and AUTH_KEY**. These will be used later.
5. Also copy the **REST_API_KEY** from the API & Auth Key tab.
6. Navigate to the Users tab, and delete all the default users and groups leaving it clean **(very important)**.
7. Download the repository [here](https://github.com/hieptl/webex/archive/main.zip) or by running `git clone https://github.com/hieptl/webex.git` and open it in a code editor.
...
Questions about running the demo? [Open an issue](https://github.com/hieptl/webex/issues). We're here to help ✌️
